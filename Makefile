...
SRCS=calmwm.cxx group.cxx strlcat.cxx util.cxx xutil.cxx client.cxx kbfunc.cxx screen.cxx strlcpy.cxx xevents.cxx y.tab.cxx conf.cxx menu.cxx search.cxx strtonum.cxx
